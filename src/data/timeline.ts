...
export const timeline: TimelineItem[] = [
  ...
  { org: 'Cambridge',          role: 'MPhil ML & Machine Intelligence',      when: 'Oct 2026',            position: 'down', future: true, note: 'First choice · closing funding gap' },
  { org: 'Uni Tübingen',       role: 'MSc Machine Learning',                when: 'Oct 2026',            position: 'up', future: true, note: 'If funding falls through' },
];
