...
| File | Purpose |
|------|---------|
| `index.html` | Single-page site: Hero → About → **Selected Work** (6 flagship cards) → **Funding** → Full Research Portfolio → News → CV sections |
...
- **Selected Work section** (`#selected-work`): 3 papers, lean list style (no hero images), siyuanguo-inspired. Pure mech interp / alignment / theory only. No applied ML or generic safety papers in this section. The two questions in About inline-link to specific papers (siyuanguo pattern). Curate ruthlessly.
...
- **About section: the research statement, ~180 words, organised around two questions.**
